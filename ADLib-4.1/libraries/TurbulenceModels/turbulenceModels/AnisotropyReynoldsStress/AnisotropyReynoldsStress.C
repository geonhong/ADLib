...
void Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::boundNormalStress
(
...
template<class BasicTurbulenceModel>
void Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::correctWallShearStress
(
    volSymmTensorField& R
) const
{
...
template<class BasicTurbulenceModel>
Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::AnisotropyReynoldsStress
(
...
template<class BasicTurbulenceModel>
bool Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::read()
{
...
Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::R() const
{
    return R_;
}
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volSymmTensorField>
Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::B() const
{
    return B_;
}
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volSymmTensorField>
Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::devRhoReff() const
{
...
Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
template<class BasicTurbulenceModel>
void Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::correct()
{
...
template<class BasicTurbulenceModel>
void Foam::AnisotropyReynoldsStress<BasicTurbulenceModel>::update
(
	const volScalarField& k
)
{
    R_ = 2.0*k*(B_ + sphericalTensor::oneThirdI);
}
